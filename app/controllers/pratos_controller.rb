class PratosController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @prato.save
        format.html { redirect_to @prato, notice: 'Prato foi criado com sucesso.' }
  ...
  def update
    respond_to do |format|
      if @prato.update(prato_params)
        format.html { redirect_to @prato, notice: 'Prato foi editado com sucesso.' }
  ...
  def destroy
    @prato.destroy
    respond_to do |format|
      format.html { redirect_to pratos_url, notice: 'Prato foi removido com sucesso.' }
